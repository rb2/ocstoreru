...
class ModelUserUserGroup extends Model {
	public function addUserGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "user_group (name, permission) VALUES ('" . $this->db->escape($data['name']) . "', '" . (isset($data['permission']) ? $this->db->escape(serialize($data['permission'])) : '') . "')");
	}
