...
class ControllerPaymentWebmoneyWMU extends Controller {
	...
	public function index() {
		...
		$this->document->breadcrumbs[] = array(
   		...
   		$this->document->breadcrumbs[] = array(
       		'href'      => HTTPS_SERVER . 'index.php?route=payment/webmoney_wmu&token=' . $this->session->data['token'],
       		'text'      => $this->language->get('heading_title'),
      		'separator' => ' :: '
   		);
		
		$this->data['action'] = HTTPS_SERVER . 'index.php?route=payment/webmoney_wmu&token=' . $this->session->data['token'];
