...
<div class="box">
  ...
  <div class="heading">
	...
	<a onclick="document.getElementById('form').submit();" class="button"><span><?php echo $button_delete; ?></span></a> &nbsp;&nbsp;&nbsp;&nbsp;
	<a onclick="$('#form').attr('action', '<?php echo $enable; ?>'); $('#form').submit();" class="button"><span><?php echo $button_enable; ?></span></a>
	<a onclick="$('#form').attr('action', '<?php echo $disable; ?>'); $('#form').submit();" class="button"><span><?php echo $button_disable; ?></span></a>
    </div>
  </div>
  <div class="content">
