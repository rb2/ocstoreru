...
$_['error_default']    = 'Эта группу покупателей нельзя удалить, поскольку она используется по умолчанию!';
...
$_['error_registred']  = 'Эта группу покупателей нельзя удалить, поскольку она используется при региcтрации покупателей!';
?>