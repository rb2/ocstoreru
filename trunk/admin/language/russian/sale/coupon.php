...
$_['entry_uses_customer'] = 'Использовать купон для этого количества клиентов: <br /><span class="help">Сколько раз максимально может использоваться купон одним клиентом. Для бесконечного использования оставить пустым.</span>';
