...
$_['entry_stock_status']     = 'Наличие товара:';//'Остутствие на складе:<br /><span class="help">Статус, показываемый, когда товара нет на складе</span>';
...
$_['entry_text']             = 'Значение:';
$_['entry_option']           = 'Атрибуты:';
