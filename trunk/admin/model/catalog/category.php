...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "category (parent_id, sort_order, status, date_modified, date_added) VALUES ('" . (int)$data['parent_id'] . "', '" . (int)$data['sort_order'] . "', '" . (int)$data['status'] . "', NOW(), NOW())");
