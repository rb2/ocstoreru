...
class ModelSaleCustomerGroup extends Model {
	public function addCustomerGroup($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "customer_group SET approval = '" . (int)$data['approval'] . "', company_display = '" . (int)$data['company_display'] . "', company_required = '" . (int)$data['company_required'] . "', tax_display = '" . (int)$data['tax_display'] . "', tax_required = '" . (int)$data['tax_required'] . "', sort_order = '" . (int)$data['sort_order'] . "'");
