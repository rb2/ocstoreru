...
class ModelLocalisationZone extends Model {
	public function addZone($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "zone (status, name, code, country_id) VALUES ('" . (int)$data['status'] . "', '" . $this->db->escape($data['name']) . "', '" . $this->db->escape($data['code']) . "', '" . (int)$data['country_id'] . "')");
	...
	public function getZones($data = array()) {
		$sql = "SELECT *, z.name, c.name AS country, z.status AS zstatus FROM " . DB_PREFIX . "zone z LEFT JOIN " . DB_PREFIX . "country c ON (z.country_id = c.country_id)";
