...
class ModelCatalogInformation extends Model {
	public function addInformation($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "information (sort_order, status) VALUES ('" . (int)$this->request->post['sort_order'] . "', '" . (int)$data['status'] . "')");

		$information_id = $this->db->getLastId();

		foreach ($data['information_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description (information_id, language_id, title, description) VALUES ('" . (int)$information_id . "', '" . (int)$language_id . "', '" . $this->db->escape($value['title']) . "', '" . $this->db->escape($value['description']) . "')");
		}
