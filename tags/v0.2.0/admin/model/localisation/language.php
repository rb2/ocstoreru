...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "language (name, code, locale, directory, filename, image, sort_order, status) VALUES ('" . $this->db->escape($data['name']) . "', '" . $this->db->escape($data['code']) . "', '" . $this->db->escape($data['locale']) . "', '" . $this->db->escape($data['directory']) . "', '" . $this->db->escape($data['filename']) . "', '" . $this->db->escape($data['image']) . "', '" . $this->db->escape($data['sort_order']) . "', '" . (int)$data['status'] . "')");
		...
		foreach ($query->rows as $category) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description (category_id, language_id, name, meta_description, description) VALUES ('" . (int)$category['category_id'] . "','" . (int)$language_id . "','" . $this->db->escape($category['name']) . "', '" . $this->db->escape($category['meta_description']) . "', '" . $this->db->escape($category['description']) . "')");
		}
		...
		foreach ($query->rows as $coupon) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "coupon_description (coupon_id, language_id, name, description) VALUES ('" . (int)$coupon['coupon_id'] . "', '" . (int)$language_id . "', '" . $this->db->escape($coupon['name']) . "', '" . $this->db->escape($coupon['description']) . "')");
		}
		...
		foreach ($query->rows as $information) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "information_description (information_id, language_id, title, description) VALUES ('" . (int)$information['information_id'] . "', '" . (int)$language_id . "', '" . $this->db->escape($information['title']) . "', '" . $this->db->escape($information['description']) . "')");
		}
		...
		foreach ($query->rows as $order_status) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "order_status (order_status_id, language_id, name) VALUES ('" . (int)$order_status['order_status_id'] . "', '" . (int)$language_id . "', '" . $this->db->escape($order_status['name']) . "')");
		}
		...
		foreach ($query->rows as $product) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_description (product_id, language_id, name, meta_description, description) VALUES ('" . (int)$product['product_id'] . "', '" . (int)$language_id . "', '" . $this->db->escape($product['name']) . "', '" . $this->db->escape($product['meta_description']) . "', '" . $this->db->escape($product['description']) . "')");
		}
		...
		foreach ($query->rows as $product_option) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_description (product_option_id, language_id, product_id, name) VALUES ('" . (int)$product_option['product_option_id'] . "', '" . (int)$language_id . "', '" . (int)$product_option['product_id'] . "', '" . $this->db->escape($product_option['name']) . "')");
		}
		...
		foreach ($query->rows as $product_option_value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value_description (product_option_value_id, language_id, product_id, name) VALUES ('" . (int)$product_option_value['product_option_value_id'] . "', '" . (int)$language_id . "', '" . (int)$product_option_value['product_id'] . "', '" . $this->db->escape($product_option_value['name']) . "')");
		}
		...
		foreach ($query->rows as $store) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "store_description (store_id, language_id, description) VALUES ('" . (int)$store['store_id'] . "', '" . (int)$language_id . "', '" . $this->db->escape($store['description']) . "')");
		}
