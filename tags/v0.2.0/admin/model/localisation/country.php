...
class ModelLocalisationCountry extends Model {
	public function addCountry($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "country (status, name, iso_code_2, iso_code_3, address_format, postcode_required) VALUES ('" . (int)$data['status'] . "', '" . $this->db->escape($data['name']) . "', '" . $this->db->escape($data['iso_code_2']) . "', '" . $this->db->escape($data['iso_code_3']) . "', '" . $this->db->escape($data['address_format']) . "', '" . (int)$data['postcode_required'] . "')");
