...
class ModelSettingStore extends Model {
	public function addStore($data) {
	    $this->db->query("INSERT INTO " . DB_PREFIX . "store (name, url, title, meta_description, template, country_id, zone_id, language, currency, tax, customer_group_id, customer_price, customer_approval, guest_checkout, account_id, checkout_id, stock_display, stock_checkout, order_status_id, logo,  icon, image_thumb_width, image_thumb_height, image_popup_width, image_popup_height, image_category_width, image_category_height, image_product_width, image_product_height, image_additional_width, image_additional_height, image_related_width, image_related_height, image_cart_width, image_cart_height, `ssl`) VALUES ('" . $this->db->escape($data['name']) . "', url = '" . $this->db->escape($data['url']) . "', title = '" . $this->db->escape($data['title']) . "', '" . $this->db->escape($data['meta_description']) . "', '" . $this->db->escape($data['template']) . "', '" . (int)$data['country_id'] . "', '" . (int)$data['zone_id'] . "', '" . $this->db->escape($data['language']) . "', '" . $this->db->escape($data['currency']) . "', '" . (int)$data['tax'] . "', '" . (int)$data['customer_group_id'] . "', '" . (int)$data['customer_price'] . "', '" . (int)$data['customer_approval'] . "', '" . (int)$data['guest_checkout'] . "', '" . (int)$data['account_id'] . "', '" . (int)$data['checkout_id'] . "', '" . (int)$data['stock_display'] . "', '" . (int)$data['stock_checkout'] . "', '" . (int)$data['order_status_id'] . "', '" . $this->db->escape($data['logo']) . "', '" . $this->db->escape($data['icon']) . "', '" . (int)$data['image_thumb_width'] . "', '" . (int)$data['image_thumb_height'] . "', '" . (int)$data['image_popup_width'] . "', '" . (int)$data['image_popup_height'] . "', '" . (int)$data['image_category_width'] . "', '" . (int)$data['image_category_height'] . "', '" . (int)$data['image_product_width'] . "', '" . (int)$data['image_product_height'] . "', '" . (int)$data['image_additional_width'] . "', '" . (int)$data['image_additional_height'] . "', '" . (int)$data['image_related_width'] . "', '" . (int)$data['image_related_height'] . "', '" . (int)$data['image_cart_width'] . "', '" . (int)$data['image_cart_height'] . "', '" . (int)$data['ssl'] . "')");

		$store_id = $this->db->getLastId();

		foreach ($data['store_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "store_description (store_id, language_id, description') VALUES ('" . (int)$store_id . "', '" . (int)$language_id . "', '" . $this->db->escape($value['description']) . "')");
		}
